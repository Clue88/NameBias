...
df_names = df_names[df_names['is_full_name'] == "T"][["name", "frequency_male", "frequency_female"]]
...
def get_template_sentences(emotion, gender):
    ...
    sentences = df_eec[(df_eec["Person"] == person_name) & (df_eec['Emotion'] == emotion)]["Sentence"].str.replace(person_name, "{}")
    return sentences
