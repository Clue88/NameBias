...
def show_race_subplots(pickle_path: str):
    ...
    df.plot.scatter(
        x="frequency_pile",
        y="frequency_FL_corpus",
        s=0.25,
        c="color",
        alpha=0.25,
        loglog=True,
    )
    df[df.pred_race == "nh_white"].plot.scatter(
        x="frequency_pile",
        y="frequency_FL_corpus",
        s=0.25,
        c="color",
    ...
    df[df.pred_race == "nh_black"].plot.scatter(
        x="frequency_pile",
        y="frequency_FL_corpus",
        s=0.25,
        c="color",
    ...
    df[df.pred_race == "hispanic"].plot.scatter(
        x="frequency_pile",
        y="frequency_FL_corpus",
        s=0.25,
        c="color",
    ...
    df[df.pred_race == "api"].plot.scatter(
        x="frequency_pile",
        y="frequency_FL_corpus",
        s=0.25,
        c="color",
    ...
    df[df.pred_race == "aian"].plot.scatter(
        x="frequency_pile",
        y="frequency_FL_corpus",
        s=0.25,
        c="color",
...
if __name__ == "__main__":
    PICKLE_PATH = "pickles/full_cleaned.pickle"
